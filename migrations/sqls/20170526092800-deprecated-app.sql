...
ALTER TABLE `apps` ADD COLUMN `expiredOn` DATE NULL DEFAULT NULL AFTER `isDeprecated`;
ALTER TABLE `appVersions` ADD COLUMN `expiredOn` DATE NULL DEFAULT NULL AFTER `isDeprecated`;
