...
class Validation {
  ...
  validateBoolean(param) {
    return this.joi.boolean().optional().error(Error(`Parameter ${param} must be a boolean`));
  }

  validateString(param) {
    return this.joi.string().optional().error(Error(`Parameter ${param} must be a string`));
  }
  ...
  validateInteger(param) {
    return this.joi.number().integer().optional().error(Error(`Parameter ${param} must be an integer`));
  }

  validateObject(param) {
    return this.joi.object().optional().error(Error(`Parameter ${param} must be an object`));
  }
  ...
  validateArray(param) {
    return this.joi.array().error(Error(`Parameter ${param} must be an array`));
  }

  validateArrayOfStrings(param) {
    return this.joi.array().items(this.joi.string()).error(Error(`Parameter ${param} must be an array of strings`));
  }
}
