...
Db.formatAppInput = function(app) {
  ...
  app.repoUsername = _.get(app, 'repository.username');
  app.repoPassword = _.get(app, 'repository.password');
...
Db.formatAppOutput = function(app) {
  ...
  if (_.has(app, 'repoType')) {
    app.repository = {
      ...
      username: _.get(app, 'repoUsername'),
      password: _.get(app, 'repoPassword'),
      uri: _.get(app, 'repoUri'),
      tag: _.get(app, 'repoTag')
    };
    delete app.repoType;
    delete app.repoUsername;
    delete app.repoPassword;
    delete app.repoUri;
    delete app.repoTag;
  }
  return app;
