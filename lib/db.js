...
Db.formatAppOutput = (appIn) => {
  ...
  if (app.isPublic) {
    app.publishingStatus = 'public';
  } else if (app.publishRequestRejectionReason) {
    app.publishingStatus = 'rejected';
  } else if (app.publishRequestOn) {
    app.publishingStatus = 'requested';
  } else {
    app.publishingStatus = 'private';
  }
